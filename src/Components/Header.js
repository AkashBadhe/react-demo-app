          ...
          <div className="navbar-custom-menu">
            <ul className="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul className="menu">
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="%PUBLIC_URL%/assets/images/user2-160x160.jpg" className="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Developers
              ...
              <li className="dropdown user user-menu">
                <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                  <img src={`${process.env.PUBLIC_URL}/assets/images/user2-160x160.jpg`} className="user-image" alt="User Image" />
                  <span className="hidden-xs">Alexander Pierce</span>
                </a>
                <ul className="dropdown-menu">

                  <li className="user-header">
                    <img src={`${process.env.PUBLIC_URL}/assets/images/user2-160x160.jpg`}
