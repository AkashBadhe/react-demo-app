        ...
        <div >
            ...
            <Router>
                    ...
                    <section className="sidebar">
                        <div className="user-panel">
                            <div className="pull-left image">
                                <img src={`${process.env.PUBLIC_URL}/assets/images/user2-160x160.jpg`} className="img-circle" alt="User" />
                            </div>
                        ...
                        <ul className="sidebar-menu" data-widget="tree">
                            ...
                            <li className="treeview">
                                ...
                                <ul className="treeview-menu">
                                    <li><Link to={'/content'} ><i className="fa fa-circle-o"></i> About</Link></li>
                ...
                <Switch>
                    ...
                    <Route
                        path='/content'
                        render={(props) => <Content {...props} contacts={contacts} />}
                    />
                </Switch>
            </Router>
        </div>
